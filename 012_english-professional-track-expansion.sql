-- ============================================================
-- Migration 012 — استكمال مسار تعلم اللغة الإنجليزية
-- إضافة 70 أسبوع جديد (A2: 3-14, B1: 3-22, B2: 2-25, C1: 2-21)
-- مبني من: خارطة مسار تعلم اللغه الانجليزيه (محدث)
-- آمن لإعادة التشغيل (ON CONFLICT DO NOTHING)
-- ============================================================
...
SELECT id, 'eng-a2-week3', 'A2 - الأسبوع 3: A Day in an Amusement Park', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 9
...
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://www.youtube.com/watch?v=L1sa_ZQAjlc', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week3' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://learnenglish.britishcouncil.org/skills/listening/b1-listening/chatting-about-series', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-a2-w3-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week3' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://forms.gle/5DwkPZYEFEbL5qB48', 1
...
-- ============ قسم: A2 - الأسبوع 4 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week4', 'A2 - الأسبوع 4: City Life vs. Village Life', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 10
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://youtu.be/HqueToxC4d4?si=DlDPtqqoxhIlaspx', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week4' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://www.youtube.com/watch?v=hSg1eZcqMio', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-a2-w4-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week4' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://www.english-4u.de/en/grammar-quizzes/comparison.htm', 1
...
-- ============ قسم: A2 - الأسبوع 5 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week5', 'A2 - الأسبوع 5: Why People Travel', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 11
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://www.youtube.com/watch?v=GaN7qgqYrvg&list=PLrnXHWfgl8kYxbKS1PpvWUZDCk9vW_E2e', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week5' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://learnenglish.britishcouncil.org/skills/listening/b1-listening/meeting-old-friend', 1
...
-- ============ قسم: A2 - الأسبوع 6 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week6', 'A2 - الأسبوع 6: Tips for Healthy Eating', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 12
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://www.engvid.com/learn-english-grammar-few-little-a-few-a-little', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week6' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://www.patreon.com/listeningtime', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-a2-w6-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week6' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://byjus.com/english/few-a-few-little-a-little-exercises/', 1
...
-- ============ قسم: A2 - الأسبوع 7 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week7', 'A2 - الأسبوع 7: Hobbies and Free Time Activities', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 13
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://www.instagram.com/mr.ammar.adel/', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week7' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://test-english.com/listening/b1/stories-of-school-and-education-b1-english-listening-test/', 1
...
-- ============ قسم: A2 - الأسبوع 8 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week8', 'A2 - الأسبوع 8: A Strange Thing That Happened Last Night | your favorite movie’s story', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 14
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'http://bit.ly/ooe-teachers.', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-a2-w8-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 4
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week8' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://learnenglish.britishcouncil.org/skills/reading/b1-reading/digital-habits-across-generations', 1
...
-- ============ قسم: A2 - الأسبوع 9 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week9', 'A2 - الأسبوع 9: The Most Amazing Places in the World', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 15
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://www.youtube.com/watch?v=K1Rs793CjqE', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week9' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://practiceenglishlistening.blogspot.com/2025/07/english-listening-level-b1-EP33.html', 1
...
-- ============ قسم: A2 - الأسبوع 10 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week10', 'A2 - الأسبوع 10: Why People Quit Their Jobs', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 16
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://youtu.be/02fYhyGiDys', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week10' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://youtu.be/VFBJIz2U20A', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-a2-w10-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week10' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://www.grammarism.com/too-enough-exercises/', 1
...
-- ============ قسم: A2 - الأسبوع 11 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week11', 'A2 - الأسبوع 11: Life Experiences You Should Try Bucket List: 100+ Incredible Things to Do Before You Die Creating a bucket list is the single most impactful thing I''ve done in my life. This post gives you some bucket', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 17
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://www.youtube.com/watch?v=553eeL1Dvho', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week11' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://open.spotify.com/show/3GRJb6bwpKEbOOG7QFjRqS', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-a2-w11-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week11' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://test-english.com/grammar-points/a2/present-perfect/2/', 1
...
-- ============ قسم: A2 - الأسبوع 12 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week12', 'A2 - الأسبوع 12: How to Stay Motivated', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 18
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://www.lingobest.com/free-online-english-course/zero-and-first-conditionals-games-and-exercises-in-english/', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-a2-w12-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week12' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://www.perfect-english-grammar.com/first-conditional-exercise-1.html', 1
...
-- ============ قسم: A2 - الأسبوع 13 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week13', 'A2 - الأسبوع 13: Becoming More Independent', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 19
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://youtu.be/j25CFx-4g0I', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week13' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://www.patreon.com/teded', 1
...
-- ============ قسم: A2 - الأسبوع 14 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-a2-week14', 'A2 - الأسبوع 14: Celebrity Interviews', NULL, 'core_skills'::roadmap_stage_type, 'A2', 'أسبوع', NULL, 20
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://bit.ly/2ZGCqRG', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-a2-week14' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'http://TED.com', 1
...
-- ============ قسم: B1 - الأسبوع 3 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week3', 'B1 - الأسبوع 3', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 21
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w3-listening', 'Listening Practice', 'video'::roadmap_step_type, NULL, 1
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week3' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://www.youtube.com/watch?v=Zk9gtbykxiw', 1
FROM public.roadmap_steps st JOIN public.roadmap_sections s ON s.id = st.section_id JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND st.legacy_lesson_id = 'eng-b1-w3-listening' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 5 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week5', 'B1 - الأسبوع 5: Childhood Memories of a Famous Author', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 22
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w5-grammar', 'Grammar: Past habits: ''used to'', ''would'' and the past simple', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w5-reading', 'Reading: Childhood Memories of a Famous Author', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week5' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 6 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week6', 'B1 - الأسبوع 6: How People Adapt to New Cities', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 23
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://techsmith.z6rjha.net/RyaDA9', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week6' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://youtu.be/PXEqJ0xhbZE?si=thLB-Bq7un9q8wIP', 1
...
-- ============ قسم: B1 - الأسبوع 7 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week7', 'B1 - الأسبوع 7: The Future of Artificial Intelligence', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 24
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w7-grammar', 'Grammar: Future forms: ''will'', ''be going to'' and present continuous', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w7-reading', 'Reading: The Future of Artificial Intelligence', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week7' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 8 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week8', 'B1 - الأسبوع 8: A Day in the Life of a Time Traveler', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 25
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://www.speakconfidentenglish.com/fluencyschool/', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week8' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://englisheasypractice.com/', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w8-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week8' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://test-english.com/grammar-points/b1-b2/future-continuous-and-future-perfect/', 1
...
-- ============ قسم: B1 - الأسبوع 9 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week9', 'B1 - الأسبوع 9: Life Lessons from People Over 80', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 26
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://youtu.be/553eeL1Dvho?si=p7KWljF4bvcwu4rP', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w9-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week9' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://www.englishclub.com/grammar/verb-tenses_present-perfect_quiz.php#google_vignette', 1
...
-- ============ قسم: B1 - الأسبوع 10 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week10', 'B1 - الأسبوع 10: The Journey of an Olympic Athlete', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 27
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://ko-fi.com/s/b66bf4d984', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w10-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week10' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/present-perfect-simple-continuous', 1
...
-- ============ قسم: B1 - الأسبوع 12 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week12', 'B1 - الأسبوع 12: How Chocolate is Made', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 28
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w12-grammar', 'Grammar: Passive voice (present & past simple)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w12-reading', 'Reading: How Chocolate is Made', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week12' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 13 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week13', 'B1 - الأسبوع 13: The Man Who Changed the World', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 29
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://youtu.be/kmI_2wCewpU', 1
...
-- ============ قسم: B1 - الأسبوع 14 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week14', 'B1 - الأسبوع 14: The Pros and Cons of Social Media', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 30
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w14-grammar', 'Grammar: Contrasting ideas: ''although'', ''despite'' and others', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w14-reading', 'Reading: The Pros and Cons of Social Media', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week14' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 15 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week15', 'B1 - الأسبوع 15: How to Be Confident: Are You Good Enough?', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 31
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w15-grammar', 'Grammar: Using ''enough''', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w15-reading', 'Reading: How to Be Confident: Are You Good Enough?', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week15' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 16 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week16', 'B1 - الأسبوع 16: What If You Lived on Mars?', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 32
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w16-grammar', 'Grammar: Conditionals: zero, first and second', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w16-reading', 'Reading: What If You Lived on Mars?', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week16' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 17 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week17', 'B1 - الأسبوع 17: If Only I Had Followed My Dreams', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 33
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w17-grammar', 'Grammar: Wishes: ''wish'' and ''if only''', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w17-reading', 'Reading: If Only I Had Followed My Dreams', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week17' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 18 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week18', 'B1 - الأسبوع 18: Psychology: How to Read People’s Minds', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 34
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w18-grammar', 'Grammar: Question tags', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w18-reading', 'Reading: Psychology: How to Read People’s Minds', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week18' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 19 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week19', 'B1 - الأسبوع 19: The Importance of Believing in Yourself', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 35
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w19-grammar', 'Grammar: Reflexive pronouns', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w19-reading', 'Reading: The Importance of Believing in Yourself', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week19' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 20 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week20', 'B1 - الأسبوع 20: The Secret Conversations of World Leaders', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 36
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w20-grammar', 'Grammar: Reported speech (basic statements & questions)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w20-reading', 'Reading: The Secret Conversations of World Leaders', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week20' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 21 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week21', 'B1 - الأسبوع 21: The Benefits of Learning New Skills', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 37
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w21-grammar', 'Grammar: Gerunds & infinitives', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w21-reading', 'Reading: The Benefits of Learning New Skills', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week21' ON CONFLICT DO NOTHING;

-- ============ قسم: B1 - الأسبوع 22 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b1-week22', 'B1 - الأسبوع 22: Why Do Celebrities Look Perfect?', NULL, 'core_skills'::roadmap_stage_type, 'B1', 'أسبوع', NULL, 38
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w22-grammar', 'Grammar: Causative form (have/get something done)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b1-w22-reading', 'Reading: Why Do Celebrities Look Perfect?', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b1-week22' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 2 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week2', 'B2 - الأسبوع 2: The Importance of Proper Punctuation in Writing', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 39
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://www.youtube.com/watch?v=yNK5GRXsLJM', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week2' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://www.youtube.com/watch?v=KUKgJsvoDUk', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w2-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week2' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2/capital-letters-apostrophes', 1
...
-- ============ قسم: B2 - الأسبوع 3 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week3', 'B2 - الأسبوع 3: Describing Extreme Weather Conditions', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 40
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://youtu.be/2zUMRoG9oa8?si=xrB3QI5UwD8FRa7r', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week3' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://youtu.be/P-QZ5Om9_20?si=tgu7JI6jsQauyQWQ', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w3-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week3' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2/adjectives-gradable-non-gradable', 1
...
-- ============ قسم: B2 - الأسبوع 4 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week4', 'B2 - الأسبوع 4: Comparing Lifestyles in Different Countries', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 41
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://www.youtube.com/watch?v=dJc0oRlIfoY&list=PLxSMFOK97J0MfJIcb60N__yBC05myTm-R&index=33', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week4' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://youtu.be/YMyofREc5Jk?si=VimtFSG4cSWsfC0D', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w4-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week4' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://www.linkedin.com/pulse/global-living-exploring-richness-worldwide-lifestyles-straukiene-2z2ce/', 1
...
-- ============ قسم: B2 - الأسبوع 5 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week5', 'B2 - الأسبوع 5: The Role of Metaphors in Language', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 42
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/using-as-like', 1
...
-- ============ قسم: B2 - الأسبوع 6 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week6', 'B2 - الأسبوع 6: Historical Events and Their Consequences', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 43
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w6-grammar', 'Grammar: Past perfect', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w6-reading', 'Reading: Historical Events and Their Consequences', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week6' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 7 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week7', 'B2 - الأسبوع 7: Predictions for the World in 2050', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 44
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://www.speakconfidentenglish.com/future-continuous-future-perfect', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week7' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://www.youtube.com/watch?v=6_q_LHq85Cs', 1
...
-- ============ قسم: B2 - الأسبوع 8 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week8', 'B2 - الأسبوع 8: Unfinished Plans and Missed Opportunities', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 45
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'http://www.bbc.co.uk/learningenglish/english/course/towards-advanced/unit-15/session-1', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week8' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'http://kickanxietycourse.com', 1
...
-- ============ قسم: B2 - الأسبوع 9 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week9', 'B2 - الأسبوع 9: How Products Are Made – A Look Inside Factories', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 46
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://youtu.be/-o4ngM0Hyaw', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week9' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://www.youtube.com/@NicksKitchen', 1
...
-- ============ قسم: B2 - الأسبوع 10 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week10', 'B2 - الأسبوع 10: Understanding Body Language and What It Tells Us', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 47
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://talksmate.com', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week10' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://www.jnforensics.com/', 1
...
-- ============ قسم: B2 - الأسبوع 11 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week11', 'B2 - الأسبوع 11: Investigating Mysterious Events in History', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 48
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/modals-deductions-about-past', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week11' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'http://history.com/schedule.', 1
...
-- ============ قسم: B2 - الأسبوع 12 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week12', 'B2 - الأسبوع 12: What If? Exploring Alternate Histories', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 49
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/conditionals-third-mixed', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week12' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://bit.ly/AlternateHistoryHub2', 1
...
-- ============ قسم: B2 - الأسبوع 13 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week13', 'B2 - الأسبوع 13: Famous Quotes and Their Meanings', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 50
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/reported-speech-statements', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week13' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://youtu.be/N5ERGH4XpjI?si=TZ09OXsT8IC6UMyD', 1
...
-- ============ قسم: B2 - الأسبوع 14 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week14', 'B2 - الأسبوع 14: Interviewing a Famous Person', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 51
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو الشرح', 'https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/reported-speech-questions', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week14' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'فيديو استماع الأسبوع', 'https://bit.ly/3gZJaNy', 1
...
-- ============ قسم: B2 - الأسبوع 15 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week15', 'B2 - الأسبوع 15: How Journalists Report the News', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 52
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w15-grammar', 'Grammar: Reported speech: reporting verbs', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w15-reading', 'Reading: How Journalists Report the News', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week15' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 17 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week17', 'B2 - الأسبوع 17: Common Phrasal Verbs in Everyday Conversations', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 53
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w17-grammar', 'Grammar: Phrasal verbs', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w17-reading', 'Reading: Common Phrasal Verbs in Everyday Conversations', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week17' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 18 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week18', 'B2 - الأسبوع 18: Why Phrasal Verbs Can Be Confusing', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 54
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w18-grammar', 'Grammar: Phrasal verbs with multiple meanings', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w18-reading', 'Reading: Why Phrasal Verbs Can Be Confusing', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week18' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 19 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week19', 'B2 - الأسبوع 19: Emphasizing Important Moments in History', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 55
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w19-grammar', 'Grammar: Cleft sentences (It was... that / What... was)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w19-reading', 'Reading: Emphasizing Important Moments in History', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week19' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 20 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week20', 'B2 - الأسبوع 20: Extreme Sports and Daring Feats', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 56
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w20-grammar', 'Grammar: Inversion for emphasis (Not only... but also / Never have I...)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w20-reading', 'Reading: Extreme Sports and Daring Feats', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week20' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 22 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week22', 'B2 - الأسبوع 22: Time-Saving Techniques for Busy People', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 57
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w22-grammar', 'Grammar: Participle clauses (Having finished, he left...)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w22-reading', 'Reading: Time-Saving Techniques for Busy People', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week22' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 23 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week23', 'B2 - الأسبوع 23: How Accurate Are Future Predictions?', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 58
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w23-grammar', 'Grammar: The future: degrees of certainty', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w23-reading', 'Reading: How Accurate Are Future Predictions?', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week23' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 24 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week24', 'B2 - الأسبوع 24: The Greatest Athletes and Their Abilities', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 59
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w24-grammar', 'Grammar: Past ability', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w24-reading', 'Reading: The Greatest Athletes and Their Abilities', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week24' ON CONFLICT DO NOTHING;

-- ============ قسم: B2 - الأسبوع 25 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-b2-week25', 'B2 - الأسبوع 25: Common Mistakes in Learning English', NULL, 'core_skills'::roadmap_stage_type, 'B2', 'أسبوع', NULL, 60
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w25-grammar', 'Grammar: Verbs followed by ''-ing'' or infinitive to change meaning', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-b2-w25-reading', 'Reading: Common Mistakes in Learning English', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-b2-week25' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 2 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week2', 'C1 - الأسبوع 2: The Passive Voice in Scientific Writing Social Media', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 61
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;
...
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو الشرح', 'https://youtu.be/8x4K9INW2Zg?si=0Q1157bH8crC1pAT', 1
...
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week2' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'youtube'::resource_kind, 'فيديو استماع الأسبوع', 'https://youtu.be/ImdtZKSdPuc?si=s8Zyf5H9xERcInPo', 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w2-tasks', 'مهام الأسبوع', 'exercise'::roadmap_step_type, NULL, 5
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week2' ON CONFLICT DO NOTHING;
INSERT INTO public.roadmap_resources (step_id, scope, kind, title, external_url, order_index)
SELECT st.id, 'external'::resource_scope, 'external_article'::resource_kind, 'رابط مهام الأسبوع', 'https://file.notion.so/f/f/29c22782-a59b-4e99-95ac-19846f3dc9c6/7be57d3e-5b3b-46a5-a3c1-69fa2588d045/CAT_C1_ToungeTwister_Jasmine.pdf?table=block&id=1b18f916-0372-8188-8e87-ee339eb04d05&spaceId=29c22782-a59b-4e99-95ac-19846f3dc9c6&expirationTimestamp=1784282400000&signature=4pTBigMlqhb0Lr-o_CUBUIGTp_8EZX5_K14tBuSpMpQ&downloadName=CAT_C1_ToungeTwister_Jasmine.pdf', 1
...
-- ============ قسم: C1 - الأسبوع 4 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week4', 'C1 - الأسبوع 4: Mastering Phrasal Verbs in Business English', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 62
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w4-grammar', 'Grammar: Word order in phrasal verbs', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w4-reading', 'Reading: Mastering Phrasal Verbs in Business English', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week4' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 5 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week5', 'C1 - الأسبوع 5: Famous Cities That Have Changed Over Time', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 63
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w5-grammar', 'Grammar: Advanced relative clauses (reduced relative clauses)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w5-reading', 'Reading: Famous Cities That Have Changed Over Time', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week5' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 6 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week6', 'C1 - الأسبوع 6: A Day in the Life of a Journalist', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 64
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w6-grammar', 'Grammar: Advanced Participle clauses', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w6-reading', 'Reading: A Day in the Life of a Journalist', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week6' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 7 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week7', 'C1 - الأسبوع 7: The Power of Minimalism in Writing', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 65
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w7-grammar', 'Grammar: Ellipsis', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w7-reading', 'Reading: The Power of Minimalism in Writing', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week7' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 8 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week8', 'C1 - الأسبوع 8: Editing Techniques for Concise Writing', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 66
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w8-grammar', 'Grammar: Avoiding repetition in a text', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w8-reading', 'Reading: Editing Techniques for Concise Writing', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week8' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 10 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week10', 'C1 - الأسبوع 10: Mysteries of the Universe', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 67
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w10-grammar', 'Grammar: Inversion after negative adverbials', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w10-reading', 'Reading: Mysteries of the Universe', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week10' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 11 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week11', 'C1 - الأسبوع 11: Alternative Histories: What If Events Had Turned Out Differently', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 68
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w11-grammar', 'Grammar: Inversion and conditionals', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w11-reading', 'Reading: Alternative Histories: What If Events Had Turned Out Differently', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week11' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 12 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week12', 'C1 - الأسبوع 12: Theories About Extraterrestrial Life', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 69
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w12-grammar', 'Grammar: Modals: probability', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w12-reading', 'Reading: Theories About Extraterrestrial Life', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week12' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 13 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week13', 'C1 - الأسبوع 13: Time Travel in Science Fiction', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 70
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w13-grammar', 'Grammar: Unreal time', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w13-reading', 'Reading: Time Travel in Science Fiction', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week13' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 14 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week14', 'C1 - الأسبوع 14: The Role of Formal Language in Academic Writing', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 71
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w14-grammar', 'Grammar: Nominalization', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w14-reading', 'Reading: The Role of Formal Language in Academic Writing', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week14' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 15 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week15', 'C1 - الأسبوع 15: Legal Language and Formal Requests', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 72
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w15-grammar', 'Grammar: Subjunctive mood', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w15-reading', 'Reading: Legal Language and Formal Requests', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week15' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 16 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week16', 'C1 - الأسبوع 16: How News Agencies Report Global Events', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 73
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w16-grammar', 'Grammar: Patterns with reporting verbs', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w16-reading', 'Reading: How News Agencies Report Global Events', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week16' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 17 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week17', 'C1 - الأسبوع 17: Interview with a Nobel Prize Winner', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 74
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w17-grammar', 'Grammar: Reported speech: cleft sentences, inversion and auxiliaries', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w17-reading', 'Reading: Interview with a Nobel Prize Winner', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week17' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 19 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week19', 'C1 - الأسبوع 19: How to Write a Persuasive Argument', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 75
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w19-grammar', 'Grammar: Advanced discourse markers', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w19-reading', 'Reading: How to Write a Persuasive Argument', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week19' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 20 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week20', 'C1 - الأسبوع 20: The Art of Diplomatic Communication', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 76
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w20-grammar', 'Grammar: Hedging (softening statements)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w20-reading', 'Reading: The Art of Diplomatic Communication', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week20' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 21 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week21', 'C1 - الأسبوع 21: The Impact of Social Media on Modern Communication', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 77
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w21-grammar', 'Grammar: Emphatic structures beyond inversion (e.g., fronting)', 'reading'::roadmap_step_type, NULL, 1
...
INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w21-reading', 'Reading: The Impact of Social Media on Modern Communication', 'reading'::roadmap_step_type, NULL, 2
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week21' ON CONFLICT DO NOTHING;

-- ============ قسم: C1 - الأسبوع 22 ============
INSERT INTO public.roadmap_sections (roadmap_id, slug, title, description, stage_type, difficulty_level, estimated_duration, icon, order_index)
SELECT id, 'eng-c1-week22', 'C1 - الأسبوع 22', NULL, 'advanced_topics'::roadmap_stage_type, 'C1', 'أسبوع', NULL, 78
FROM public.roadmaps WHERE slug = 'english-professional-track'
ON CONFLICT DO NOTHING;

INSERT INTO public.roadmap_steps (section_id, legacy_lesson_id, title, step_type, estimated_duration, order_index)
SELECT s.id, 'eng-c1-w22-grammar', 'Grammar: Reading Tool: Listening Tool: Writing Tool', 'reading'::roadmap_step_type, NULL, 1
FROM public.roadmap_sections s JOIN public.roadmaps r ON r.id = s.roadmap_id WHERE r.slug = 'english-professional-track' AND s.slug = 'eng-c1-week22' ON CONFLICT DO NOTHING;

-- تحديث الوصف العام للمسار ليعكس المحتوى الفعلي الجديد
UPDATE public.roadmaps
SET duration_label = '75 أسبوع محتوى فعلي عبر A2 → C1 (+نظرة عامة A1)'
